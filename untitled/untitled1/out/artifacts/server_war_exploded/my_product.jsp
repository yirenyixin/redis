...
<div class="mainsrp-itemlist">
    <c:forEach items="${all}" var="product" >
        <a href="update_product.jsp?name=${product.name}&price=${product.price}&img=${product.img}&type=${product.type}&size=${product.size}&color=${product.color}&shopid=${product.shopid}&num=${product.stock}&id=${product.id}&uid=<%=session.getAttribute("uId")%>&packed=${product.produc_packed}">
